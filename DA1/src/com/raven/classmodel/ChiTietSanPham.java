...
public class ChiTietSanPham {
    ...
    public ChiTietSanPham(int stt, UUID id, String ma, String ten, int soLuong, BigDecimal gia, int trangThai, int ghiChu, MauSac id_mausac, ChatLieu id_chatlieu, KichCo id_kichCo, NhanHieu id_nhanHieu, DeGiay id_deGiay, DayGiay id_daygiay, KieuDang id_kieuDang, HinhAnh id_hinhanh, SanPham id_sanPham, NhanVien id_nhanVien, KhachHang id_khachHang) {
        this.stt = stt;
        this.id = id;
        this.ma = ma;
        this.ten = ten;
    ...
    public ChiTietSanPham(int stt, String ma, String ten, int soLuong, BigDecimal gia, int trangThai, int ghiChu, MauSac id_mausac, ChatLieu id_chatlieu, KichCo id_kichCo, NhanHieu id_nhanHieu, DeGiay id_deGiay, DayGiay id_daygiay, KieuDang id_kieuDang, HinhAnh id_hinhanh, SanPham id_sanPham, NhanVien id_nhanVien, KhachHang id_khachHang) {
        this.stt = stt;
        this.ma = ma;
        this.ten = ten;
        this.soLuong = soLuong;
    ...
    public HinhAnh getId_hinhanh() {
        return id_hinhanh;
    }

    public void setId_hinhanh(HinhAnh id_hinhanh) {
        this.id_hinhanh = id_hinhanh;
    }
