...
public class Menu extends javax.swing.JPanel {
    ...
    public void initMenuItem() {
        ...
        addMenu(new ModelMenu(resizeIcon(new ImageIcon(getClass().getResource("/com/raven/icon/khuyenmai.png")),20, 20), "Giảm Giá","Đợt Giảm Giá", "Phiếu Giảm Giá"));
    ...
    protected void paintComponent(Graphics grphcs) {
        ...
        GradientPaint gra = new GradientPaint(0, 0, new Color(36,36,238), getWidth(), 0, new Color(72,72,238));
        g2.setPaint(gra);
