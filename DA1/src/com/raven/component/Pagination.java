...
public class Pagination extends JPanel {
    ...
    private void changePage(int current, int totalPage) {
        ...
        removeAll();
        refresh();
        JButton cmdPrev = paginationItemRender.createPaginationItem("<", true, false, page.isPrevious());
        ...
        JButton cmdNext = paginationItemRender.createPaginationItem(">", false, true, page.isNext());
