 ...
 * @author ADMIN
 */
class UpdateStatusThread1 extends Thread {
...
public class Voucher extends javax.swing.JPanel{
    ...
    public Voucher() {
        initComponents();
        UpdateStatusThread1 thread = new UpdateStatusThread1();
...
//                JOptionPane.showMessageDialog(this, "Sửa thành công");
    ...
    public void fillTable(List<com.raven.classmodel.Voucher> list) {
        ...
        for (com.raven.classmodel.Voucher vc : list) {
            ...
            Object[] toDaTaRow = new Object[]{stt++, vc.getMa(), vc.getTen(), vc.getGiatrimax(), vc.getLoaiGiamGia(), NumberFormat.getInstance().format(vc.getGiatrimin()), vc.getSoLuong(), vc.getNgayBatDau(), vc.getNgayKetThuc(), trangthai, vc.getNgayTao()};
    ...
    private void showData(int index) {
        ...
        txtMucGiam.setText(String.valueOf(vc.getGiatrimax()));
        txtGiaTriMin.setText(String.valueOf(vc.getGiatrimin()));
...
//        getid.getIDChatLieu(cbbChatLieu.getSelectedItem() + "")
        ...
        return new com.raven.classmodel.Voucher(ma, ten, mucGiamGia, loaigiam, giatrimin, soLuong, StartDate, EndDate, trangthai, ngayTao, nvv, hdd);
    }
