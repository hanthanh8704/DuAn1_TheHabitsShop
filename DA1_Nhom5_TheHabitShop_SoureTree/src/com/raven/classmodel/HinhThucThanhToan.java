...
public class HinhThucThanhToan {
    ...
    public HinhThucThanhToan(UUID ID, String ma, String magd, String ten, HoaDon id_hoaDon, ThanhToan id_thanhToan, UUID id_nguoiTao, Date ngayTao, Integer trangthai) {
        this.ID = ID;
        this.ma = ma;
        this.magd = magd;
        this.ten = ten;
