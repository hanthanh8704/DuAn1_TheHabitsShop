...
public class LichSuHoaDon {
    ...
    public LichSuHoaDon(UUID id, Integer stt, String ma, String hanhdong, String liDoHuy, UUID id_nhanVien, UUID id_hoaDon, UUID id_nguoitao, Date ngayTao, HoaDon hoaDon, NhanVien nhanVien, HoaDonChiTiet hdct, SanPham sp, ChiTietSanPham spct) {
        this.id = id;
        this.stt = stt;
        this.ma = ma;
