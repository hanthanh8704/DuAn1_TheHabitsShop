...
public class SanPhamCTKM_Dang {
    ...
    public SanPhamCTKM_Dang() {
    }

    public SanPhamCTKM_Dang( String ma, String ten, BigDecimal gia, String tenmausac, String tenchatlieu) {
    ...
    public SanPhamCTKM_Dang(String ma, String ten, BigDecimal gia, String tenmausac, String tenchatlieu, String tenkichCo, String tennhanHieu, String tendeGiay) {
        this.ma = ma;
        this.ten = ten;
        this.gia = gia;
        this.tenmausac = tenmausac;
    ...
    public SanPhamCTKM_Dang(String ma, int soLuong, int trangThai, int ghiChu, String id_mausac, String id_kichCo, String id_nhanHieu, String id_deGiay, String id_daygiay, String id_kieuDang, String id_nhanVien, String id_khachHang, String id_nguoiTao, Date ngayTao) {
        this.ma = ma;
    ...
    public SanPhamCTKM_Dang(String ma, String ten, int soLuong, String tenmausac, String tenchatlieu, String tenkichCo, String tennhanHieu, String tendeGiay, String tendaygiay, String tenkieuDang) {
        this.ma = ma;
        this.ten = ten;
        this.soLuong = soLuong;
        this.tenmausac = tenmausac;
    ...
    public Object[] toSP(){
        return new Object[] {
         this.ma,this.ten,this.gia,this.tenmausac,this.tenchatlieu
        };
    }
    public Object[] rowData(){
        return new Object[]{
            this.ma,this.ten,this.gia,this.tenmausac,this.tenchatlieu,this.tenkichCo,this.tennhanHieu,this.tendeGiay
        };
    }
