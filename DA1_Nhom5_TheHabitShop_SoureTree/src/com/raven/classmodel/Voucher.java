...
public class Voucher {
    ...
    public Voucher(String ma, String ten, BigDecimal giatrimax, String loaiGiamGia, BigDecimal giatrimin, int soLuong, Date ngayBatDau, Date ngayKetThuc, int trangThai, Date ngayTao) {
        this.ma = ma;
        this.ten = ten;
        this.giatrimax = giatrimax;
        this.loaiGiamGia = loaiGiamGia;
