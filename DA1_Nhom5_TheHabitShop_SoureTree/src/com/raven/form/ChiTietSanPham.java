...
public class ChiTietSanPham {
    ...
    public ChiTietSanPham(int stt, String ma, String ten, int soLuong, BigDecimal gia, int trangThai, int ghiChu, MauSac id_mausac, ChatLieu id_chatlieu, KichCo id_kichCo, NhanHieu id_nhanHieu, DeGiay id_deGiay, DayGiay id_daygiay, KieuDang id_kieuDang, SanPham id_sanPham, NhanVien id_nhanVien, KhachHang id_khachHang) {
        this.stt = stt;
        this.ma = ma;
        this.ten = ten;
        this.soLuong = soLuong;
