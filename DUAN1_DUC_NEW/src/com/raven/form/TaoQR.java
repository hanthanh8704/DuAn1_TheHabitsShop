...
import com.raven.model.ZXingHelper1;
...
public static byte[] getQRCodeImage(String text, int width, int height) {
    ...
    private void btnQRActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnQRActionPerformed
        ...
        if (qr.isEmpty()) {
            ...
            try {
                byte[] result = ZXingHelper1.getQRCodeImage(qr, 300, 200);

                if (result != null) {
                    // Kiểm tra xem lblQuetMa đã được khởi tạo chưa
                    if (lblQuetMa != null) {
                        lblQuetMa.setIcon(new ImageIcon(result));
                    } else {
                        System.out.println("lblQuetMa is null");
                    }
                } else {
    ...
    private void btnBarCodeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBarCodeActionPerformed
        ...
        if (barCode.isEmpty()) {
            ...
            byte[] resuilt = ZXingHelper1.getBarCodeImage(barCode, 300, 200);
